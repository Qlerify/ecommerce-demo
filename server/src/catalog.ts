...
export const products: Product[] = [
  ...
  },
  {
    ...
    description:
      "An expanding carry-on built for two weeks abroad. Sailcloth shell, hidden laptop sleeve, and a lay-flat clamshell.",
    collection: "Travel",
    type: "Bags",
...
export const shippingOptions = [
  { id: "so_standard", name: "Standard Shipping (3-5 days)", amount: 6, optionId: "std" },
  { id: "so_express", name: "Express (1-2 days)", amount: 18, optionId: "exp" },
  { id: "so_pickup", name: "In-store Pickup", amount: 0, optionId: "pickup" },
]
